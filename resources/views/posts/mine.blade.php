    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-10">
                <h1 class="text-3xl font-bold text-blue-800 mb-2">{{ auth()->user()->name }}'s Lost & Found Items</h1>
                <p class="text-lg text-blue-600">Browse your reported items</p>
                <div class="mt-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                @empty
                    <div class="col-span-full text-center py-12">
                        ...
                        <h3 class="mt-4 text-lg font-medium text-gray-900">No items found, {{ auth()->user()->name }}</h3>
                        <p class="mt-1 text-gray-500">You haven't posted any lost or found items yet.</p>
                        <div class="mt-6">
