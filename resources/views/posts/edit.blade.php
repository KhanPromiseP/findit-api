    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mb-10">
                <h1 class="text-3xl font-bold text-blue-800 mb-2">Edit Item</h1>
                <p class="text-lg text-blue-600">Update the item details</p>
            </div>

            <!-- Form Container -->
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden p-8">
                <form id="editItemForm" class="space-y-6" action="{{ route('posts.update', $post) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="color" name="color" placeholder="e.g. Black, Silver, Red" 
                                   class="w-full px-4 py-3 rounded-xl border border-blue-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300"
                                   value="{{ old('color', $post->color) }}" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="contact" name="contact" placeholder="Your phone number" 
                                   class="w-full px-4 py-3 rounded-xl border border-blue-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300"
                                   value="{{ old('contact', $post->contact) }}" required>
                        </div>

                        <!-- Status Dropdown -->
                        <div>
                            <label for="status" class="block text-sm font-medium text-blue-800 mb-1">Status</label>
                        ...
                        <!-- Current Images -->
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-blue-800 mb-2">Current Images</label>
                        ...
                        <!-- New Image Upload -->
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-blue-800 mb-1">Add New Images (max 3)</label>
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="image_path" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none">
                                            ...
                                            <input id="image_path" name="image_path[]" type="file" class="sr-only" accept="image/*" multiple>
                                        </label>
                                        <p class="pl-1">or drag and drop</p>
                                    </div>
                                    <p class="text-xs text-gray-500">PNG, JPG up to 3MB each (max 3 images)</p>
                                </div>
                            </div>
                            <!-- Image Preview -->
                    ...
                    <div class="pt-4 flex justify-between">
                        <a href="{{ route('posts.show', $post) }}" 
                           class="px-6 py-4 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold rounded-xl shadow-lg transform hover:scale-[1.01] transition-all duration-300 flex items-center justify-center gap-2">
                            Cancel
                        </a>
                        <button type="submit" 
                                class="px-6 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg transform hover:scale-[1.01] transition-all duration-300 flex items-center justify-center gap-2">
    ...
    <script>
        ...
        document.getElementById('image_path').addEventListener('change', function(e) {
            ...
            if(this.files && this.files.length > 0) {
                ...
                // Update file input if more than 3 files were selected
        ...
        // In your edit page's script section
