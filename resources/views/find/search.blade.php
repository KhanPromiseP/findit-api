   ...
   <!-- Success Modal (for user) -->
                    ...
                    <div class="bg-green-50 rounded-xl p-6 mb-6 border border-green-200">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-green-700">We've received your request and will handle it with the utmost priority. Our team will contact you if we find a match in findit OR from the community.</p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.getElementById('helpFindForm').addEventListener('submit', function(e) {
            ...
            const submitButton = this.querySelector('button[type="submit"]');
            const userName = document.getElementById('help_name').value;
